...
function PlaylistByUser() {
    ...
    useEffect(()=>{
      ...
      console.log(playlistid)
       fetch(`http://localhost:8000/api/PlaylistSongs?playlistid=${playlistid}`, requestOptions)
    ...
    <div className="pbucontainer">
      <div className="pbutopgradient"></div>
        ...
        <div className='pbuheader'>
          ...
          {userSongs.length<=0 ? <><div className="pbucreatedby">
          ...
          <>
           <div className='playlistByUserSongs'>
            <img className='playlistByUserSongImgs1' src={playlistSongImgIconTest} />
            <img className='playlistByUserSongImgs2' src={playlistSongImgIconTest} />
            <img className='playlistByUserSongImgs3'  src={playlistSongImgIconTest}/>
            <img className='playlistByUserSongImgs4'  src={playlistSongImgIconTest}/>
        </div>
        
        <div className='playlistByUserSongOptions'>
          <div className='playlistByUserOptions'>
            <button className="playlistByUserImporvePlaylist">Mejorar Playlist</button>
            <img src={playlistUserLock}/>
            <button className='playlistByUserShareIcon'><img src={playlistusershareIcon}/></button>
          </div>
          <div className='playlistUserLenght'>
            <p className='playlistUserTime'>1h 19m</p>
            <img className='playlistUserTimeWheel' src={playlistUserTimeIcon}/>
          </div>
        </div>

        <div className='playlistByUserMoreOptions'>
          <Link to={'/profile/playlist/addsongs'}><button className='playlistByUserAddSongs'><img src={playlistAddSong}/>Añadir Cancion</button></Link>
          <div>
            <button className='playlistByUserShuffle'><img src={playlistShuffleIcon}/></button>
            <button className='playlistByUserPlay'><img src={playlistPlayIcon}/></button>
          </div>
        </div>
          ...
          <ul className='playlistByUserSongListsofSongs'>
           ...
           return <li>
            <div className='playlistByUseriListSongContent'>
              <img className='playlistByUserListSongsImg' src={playlistSongImgIconTest}/>
              <div className='playlistByUserListSongInfo'>
                  <h4>{item.song_name}</h4>
                  <p className='playlistByUserListsSongInfoArtist'>{item.artist_name}</p>
              </div>
              <button className='playlistByUserListMoreInfoButton'><img src={playlistMoreButton}/></button>
            </div>
          </li>
           })}
