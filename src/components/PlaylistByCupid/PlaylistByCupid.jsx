...
function PlaylistByCupid() {
  ...
  useEffect(() => {
    const getSongs = async () => {
      ...
      await fetch(
        `http://localhost:8000/api/PlaylistSongs?playlistid=${likedCupidSongs}`,
        requestOptions
      )
  ...
  return (
    <>
      <header className="playlistByCupidHeader">
        <Link to={"/Home"}>
          <button onClick={GobackHome} className="playlistByCupidGoHome">
        ...
        <button className="playlistByCupidMore">
      ...
      <body>
        ...
        <div className="playlistByCupidSongOptions">
          <div className="playlistByCupidOptions">
            <button className="playlistByCupidAlphaIcon">
              <img src={playlistaplhaicon} />
            </button>
            <img src={playlistCheckIcon} />
            <button className="playlistByCupidShareIcon">
              <img src={playlistShareButton} />
            </button>
          </div>
        ...
        <div className="playlistByCupidMoreOptions">
          <button className="playlistByCupidCreateCopy">
            <img src={PlaylistCopyIcon} />
            Crear Copia
          </button>
          <div>
            <button className="playlistByCupidShuffle">
              <img src={playlistShuffleIcon} />
            </button>
            <button className="playlistByCupidPlay">
              ...
              return (
                <li>
                  <div className="playlistByCupdiListSongContent">
                    <img
                      className="playlistByCupidListSongsImg"
                      src={`/${item.artist_img}`}
                    />
                    <div className="playlistByCupidListSongInfo">
                      <h4>{item.song_name}</h4>
                      <p className="playlistByCupidListsSongInfoArtist">
                        {item.artist_name}
                      </p>
                    </div>
                    <button className="playlistByCupidListMoreInfoButton">
                      <img src={playlistMoreButton} />
                    </button>
                  </div>
                </li>
